...
def get_random_image_path(method):
    ROOT_DIRECTORIES=[r'/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/demo_images/AA',
                      r'/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/demo_images/A',
                      r'/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/demo_images/B',
                      r'/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/demo_images/C']
    if method=='random':
...
def apply_yolo_model_return_image(image_path):
    model=YOLO(r'/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/models/best.pt')
...
with st.expander('Classifier Model Prediction'):
    #Load the model
    model = joblib.load('/Users/steliosdiamantopoulos/Desktop/deployments/YoutubeAi_Assistant/models/model2.pkl')
